...
class DataService{
    ...
    async getCatalog() {
        ...
        let result = await axios.get(this.serverURL + "/api/catalog");
        return result.data;
    ...
    async saveProduct(product) {
        let result = await axios.post(this.serverURL + "/api/catalog", product);
        return result.data;
    }

    async getCoupons() {
        let result = await axios.get(this.serverURL + "/api/coupons");
        return result.data;
    }

    async saveCoupon(coupon) {
        let result = await axios.post(this.serverURL + "/api/coupons", coupon);
        return result.data;
    }
}
